...
export const Interview_history = () => {
    ...
    // Get only the latest 3 interviews for dashboard
    ...
    const getInterviewTypeColor = (type: string) => {
        switch (type) {
            case 'personal': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 border-blue-200 dark:border-blue-700';
            case 'technical': return 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300 border-purple-200 dark:border-purple-700';
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
            ...
            >
                <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Recent Interviews</h2>
            ...
            <AnimatePresence mode="popLayout">
                {recentInterviews.length === 0 ? (
                    ...
                    >
                        ...
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-2">No interviews yet</h3>
                                ...
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getInterviewTypeColor(interview.type)}`}>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">
                                                <span className="font-medium">Questions:</span> {interview.messages.filter(m => m.role === 'assistant').length}
                                            </p>
                                            <p className="text-sm text-gray-600 dark:text-gray-300">
                                                <span className="font-medium">Responses:</span> {interview.messages.filter(m => m.role === 'user').length}
                                            </p>
                                        </div>
                                            ...
                                            <div 
                                                ...
                                                style={{ 
                                                    width: `${Math.min(
                                                        ...
                                                        interview.messages.filter(m => m.role === 'assistant').length) * 100, 
                                                        100
                                                    )}%` 
                                                }}
                                            ></div>
