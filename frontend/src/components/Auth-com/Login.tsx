...
export default function LoginPage() {
      ...
      <div className="container mx-auto px-4 py-12 flex items-center justify-center">
        <div className="w-full max-w-md p-8 rounded-2xl shadow-xl bg-white dark:bg-[#161622] border border-gray-200 dark:border-[#2e2e3a] transition-all">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-[#8a8a9b]">Sign in to your Stellar account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium mb-1 text-gray-800 dark:text-[#e0e0e0]">
                Email Address
              </label>
              <input
                type="email"
                ...
                className={`w-full px-4 py-3 bg-gray-50 dark:bg-[#1e1e2a] border ${errors.email ? 'border-red-500' : 'border-gray-200 dark:border-[#2e2e3a]'} rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all`}
  ...
  <label htmlFor="password" className="block text-sm font-medium mb-1 text-gray-800 dark:text-[#e0e0e0]">
    Password
  </label>
  <input
    ...
    className={`w-full px-4 py-3 pr-10 bg-gray-50 dark:bg-[#1e1e2a] border ${
      errors.password ? 'border-red-500' : 'border-gray-200 dark:border-[#2e2e3a]'
