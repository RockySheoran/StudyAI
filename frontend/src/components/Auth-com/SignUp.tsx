...
export default function SignupPage() {
  ...
  // Set theme based on system preference or toggle
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 py-12 flex items-center justify-center">
        ...
        <div className={`w-full max-w-md p-8 rounded-2xl shadow-xl ${themeColors[theme].container} border ${themeColors[theme].border} transition-all`}>
          <div className="text-center mb-8">
            ...
            <p className={themeColors[theme].muted}>Create your account to explore the universe</p>
          </div>
          ...
          {/* <div className="flex flex-col space-y-3 mb-6">
            <button
              ...
              className={`flex items-center justify-center py-2 px-4 border ${themeColors[theme].border} rounded-lg hover:bg-opacity-10 hover:bg-gray-500 transition-colors`}
            >
          ...
          <div className="flex items-center my-6">
            <div className={`flex-grow h-px ${themeColors[theme].border}`}></div>
            {/* <span className={`mx-4 ${themeColors[theme].muted}`}>or</span> */}
            <div className={`flex-grow h-px ${themeColors[theme].border}`}></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="name" className={`block text-sm font-medium mb-1 ${themeColors[theme].text}`}>
                Full Name
              </label>
              <input
                type="text"
                ...
                className={`w-full px-4 py-3 ${themeColors[theme].inputBg} border ${errors.name ? 'border-red-500' : themeColors[theme].border} rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 ${themeColors[theme].inputBg} border ${errors.confirmPassword ? 'border-red-500' : themeColors[theme].border} rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all`}
                placeholder="••••••••"
              />
