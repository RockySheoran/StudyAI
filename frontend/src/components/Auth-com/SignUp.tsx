...
export default function SignupPage() {
  ...
  useEffect(() => {
    ...
    else if (state.status === 400 && state.data) {
      router.push('/signup');
    }
    else if (state.status === 500 && state.data) {
      router.push('/signup');
    }
  }, [state]);
          ...
          <form action={action} className="space-y-5 mt-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 dark:bg-[#1e1e2a] border border-gray-200 dark:border-[#2e2e3a] rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
  ...
  <input
    ...
    onChange={handleChange}
    className="w-full px-4 py-3 pr-10 bg-gray-50 dark:bg-[#1e1e2a] border border-gray-200 dark:border-[#2e2e3a] rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
    placeholder="••••••••"
  />
  <button
    type="button"
  ...
  {state.errors.password && <p className="mt-1 text-sm text-red-400">{state.errors.password}</p>}
</div>
...
<div className="relative mt-4">
  ...
  {state.errors.confirmPassword && <p className="mt-1 text-sm text-red-400">{state.errors.confirmPassword}</p>}
</div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              {[
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="inline-flex w-full items-center justify-center rounded-lg border border-gray-200 dark:border-[#2e2e3a] bg-white dark:bg-[#1e1e2a] hover:bg-gray-50 dark:hover:bg-[#2a2a3a] p-3 text-sm font-medium text-gray-700 dark:text-gray-200 shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50"
          ...
          <div className="mt-6 text-center text-sm text-gray-500 dark:text-[#8a8a9b]">
            ...
            <a href="/login" className="font-medium text-indigo-500 hover:text-indigo-600">
              Log in
            </a>
          </div>
        </div>
